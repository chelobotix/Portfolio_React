  ...
  return (
    <article className="flex flex-col gap-3 bg-dark-blue bg-opacity-50 rounded-lg p-3">
      <div className="flex flex-col items-center gap-3">
        <h3 className="text-white font-light text-lg">Languages</h3>
      ...
      <div className="flex flex-col items-center gap-3">
        <h3 className="text-white font-light text-lg">Frameworks & Libraries</h3>
      ...
      <div className="flex flex-col items-center gap-3">
        <h3 className="text-white font-light text-lg">Skills</h3>
        <ul className="flex justify-center flex-wrap gap-5">
